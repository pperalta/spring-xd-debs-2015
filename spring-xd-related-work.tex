...
\begin{itemize*}
\item Spring XD provides out of the box adapters to read and write data fragments,
while Samza requires implementing the programming API, which usually is bound to 
reading and writing to Kafka topics.
