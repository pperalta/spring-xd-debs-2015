...
% These commands are suggested by the Camera Ready instructions:
% http://www.debs2015.org/camera-ready-instructions.html
\clubpenalty=10000
\widowpenalty=10000
...
% Copyright guidance courtesy of
...
\conferenceinfo{DEBS}{'15 June 29 - July 03, 2015, Oslo, Norway\\
{\mycrnotice{Copyright is held by the owner/author(s). Publication rights
licensed to ACM.}}}
\copyrightetc{ACM \the\acmcopyr}
\crdata{978-1-4503-3286-6/15/06\ ...\$15.00.\\
http://dx.doi.org/10.1145/2675743.2771879}

%\CopyrightYear{2007} % Allows default copyright year (20XX) to be over-ridden - IF NEED BE.
%\crdata{0-12345-67-8/90/01}  % Allows default copyright data (0-89791-88-6/97/05) to be over-ridden - IF NEED BE.
% --- End of Author Metadata ---

\title{Industry Paper: Spring XD -- A Modular Distributed Stream and Batch Processing System}
...
\input{spring-xd-dsl.tex}

\input{spring-xd-deployment.tex}

\input{spring-xd-analytics.tex}

\input{spring-xd-management.tex}

\input{spring-xd-use-cases.tex}

\input{spring-xd-related-work.tex}
