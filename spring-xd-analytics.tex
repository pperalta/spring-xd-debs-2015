...
A spark MLlib algorithm can be run as a sparkApp job in XD. With the streaming
data triggering a job module, one can launch the MLlib job using the stream
that collects and transforms the data from an external application.
