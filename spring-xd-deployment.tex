...
Spring XD does not provide a serving layer of its own, but, once the 
\emph{speed layer} and the \emph{batch layer} store their data in 
\emph{views}, a serving layer can be easily built using Spring Boot in
combination with Spring Data or Spring Data REST.
